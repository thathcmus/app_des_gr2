...
class UpdateProfileActivity : AppCompatActivity(), View.OnClickListener {
    private val loadingDialog = ProgressBarLoading(this@UpdateProfileActivity)
    ...
    private fun listenerEvent() {
        btnUpdateInfo.setOnClickListener() {
            ...
            if (isValidateName && isValidatePhoneNum && isValidateGender && isValidateLocation) {
                ...
                scope.launch {
                    val imageUrlDeferred = async(Dispatchers.IO) {
                    ...
                    Firestore().updateUserInfo(this@UpdateProfileActivity, userHashMap)
